...
public class BookTest {
	...
	public void testLoadFromInputStream() {
		...
		Book expectBook=new Book(
			...
			"<p>Три произведения трех писателей соседствуют в одной книге. "
			...
			+ "детей. </p>"
			+ "<p>Другой круг проблем вызван расширением контактов Венгрии с зарубежными странами. "
			+ "</p><p>Достаточно разнообразна и география представленных в сборнике произведении: "
			...
			+ "несомненное познавательное значение книги. </p>"
			+ "<p>Но, разумеется, любое произведение детективного жанра должно, прежде всего, "
